...
export const EditableContent = forwardRef<EditableContentRef, EditableContentProps>(
    ...
    return (
      <>
        ...
        <div
          ...
          className="editor-content text-lg leading-relaxed min-h-[400px] outline-none focus:outline-none"
          style={{
            whiteSpace: "pre-wrap",
            wordWrap: "break-word",
            lineHeight: "1.6",
